...
@JsonDeserialize(builder = Aminos.Builder.class)
public final class Aminos {
    ...
    private Aminos(
            Optional<Integer> alanineG,
            Optional<Integer> arginineG,
            Optional<Integer> asparagineG,
            Optional<Integer> asparticAcidG,
            Optional<Integer> cysteineG,
            Optional<Integer> glutamineG,
            Optional<Integer> glutamicAcidG,
            Optional<Integer> glycineG,
            Optional<Integer> histidineG,
            Optional<Integer> isoleucineG,
            Optional<Integer> leucineG,
            Optional<Integer> lysineG,
            Optional<Integer> methionineG,
            Optional<Integer> phenylalanineG,
            Optional<Integer> prolineG,
            Optional<Integer> serineG,
            Optional<Integer> threonineG,
            Optional<Integer> tryptophanG,
            Optional<Integer> tyrosineG,
            Optional<Integer> valineG) {
    ...
    private boolean equalTo(Aminos other) {
        return alanineG.equals(other.alanineG)
                && arginineG.equals(other.arginineG)
                && asparagineG.equals(other.asparagineG)
                && asparticAcidG.equals(other.asparticAcidG)
                && cysteineG.equals(other.cysteineG)
                && glutamineG.equals(other.glutamineG)
                && glutamicAcidG.equals(other.glutamicAcidG)
                && glycineG.equals(other.glycineG)
                && histidineG.equals(other.histidineG)
                && isoleucineG.equals(other.isoleucineG)
                && leucineG.equals(other.leucineG)
                && lysineG.equals(other.lysineG)
                && methionineG.equals(other.methionineG)
                && phenylalanineG.equals(other.phenylalanineG)
                && prolineG.equals(other.prolineG)
                && serineG.equals(other.serineG)
                && threonineG.equals(other.threonineG)
                && tryptophanG.equals(other.tryptophanG)
                && tyrosineG.equals(other.tyrosineG)
                && valineG.equals(other.valineG);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "alanine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "arginine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "asparagine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "aspartic_acid_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "cysteine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "glutamine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "glutamic_acid_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "glycine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "histidine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "isoleucine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "leucine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "lysine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "methionine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "phenylalanine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "proline_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "serine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "threonine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "tryptophan_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "tyrosine_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "valine_g", nulls = Nulls.SKIP)
