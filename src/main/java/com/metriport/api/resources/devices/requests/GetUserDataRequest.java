...
@JsonDeserialize(builder = GetUserDataRequest.Builder.class)
public final class GetUserDataRequest {
    ...
    private GetUserDataRequest(String userId, String date, String timezoneId) {
        this.userId = userId;
        this.date = date;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetUserDataRequest && equalTo((GetUserDataRequest) other);
    }

    private boolean equalTo(GetUserDataRequest other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(GetUserDataRequest other);
    }
    ...
    public static final class Builder implements UserIdStage, DateStage, TimezoneIdStage, _FinalStage {
        ...
        @Override
        public Builder from(GetUserDataRequest other) {
        ...
        @Override
        public GetUserDataRequest build() {
            return new GetUserDataRequest(userId, date, timezoneId);
        }
    }
}
