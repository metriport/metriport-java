...
@JsonDeserialize(builder = EnergyExpenditure.Builder.class)
public final class EnergyExpenditure {
    ...
    private EnergyExpenditure(
            Optional<Integer> activeKcal,
            Optional<Integer> basalMetabolicRateKcal,
            Optional<Integer> totalWatts,
            Optional<Integer> avgWatts) {
    ...
    private boolean equalTo(EnergyExpenditure other) {
        return activeKcal.equals(other.activeKcal)
                && basalMetabolicRateKcal.equals(other.basalMetabolicRateKcal)
                && totalWatts.equals(other.totalWatts)
                && avgWatts.equals(other.avgWatts);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "active_kcal", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "basal_metabolic_rate_kcal", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "total_watts", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "avg_watts", nulls = Nulls.SKIP)
