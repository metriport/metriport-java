...
@JsonDeserialize(builder = HeartRateVariability.Builder.class)
public final class HeartRateVariability {
    ...
    private HeartRateVariability(
            Optional<HeartRateVariabilityMeasurement> rmssd, Optional<HeartRateVariabilityMeasurement> sdnn) {
        this.rmssd = rmssd;
        this.sdnn = sdnn;
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "rmssd", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "sdnn", nulls = Nulls.SKIP)
