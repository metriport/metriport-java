...
@JsonDeserialize(builder = GetBodyDataRequest.Builder.class)
public final class GetBodyDataRequest {
    ...
    private GetBodyDataRequest(String userId, String date, String timezoneId) {
        this.userId = userId;
        this.date = date;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetBodyDataRequest && equalTo((GetBodyDataRequest) other);
    }

    private boolean equalTo(GetBodyDataRequest other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(GetBodyDataRequest other);
    }
    ...
    public static final class Builder implements UserIdStage, DateStage, TimezoneIdStage, _FinalStage {
        ...
        @Override
        public Builder from(GetBodyDataRequest other) {
        ...
        @Override
        public GetBodyDataRequest build() {
            return new GetBodyDataRequest(userId, date, timezoneId);
        }
    }
}
