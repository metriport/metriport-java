...
@JsonDeserialize(builder = ActivityMovement.Builder.class)
public final class ActivityMovement {
    ...
    private ActivityMovement(
            Optional<Integer> stepsCount,
            Optional<Integer> floorsCount,
            Optional<Elevation> elevation,
            Optional<Speed> speed,
            Optional<Integer> avgCadence,
    ...
    private boolean equalTo(ActivityMovement other) {
        return stepsCount.equals(other.stepsCount)
                && floorsCount.equals(other.floorsCount)
                && elevation.equals(other.elevation)
                && speed.equals(other.speed)
                && avgCadence.equals(other.avgCadence)
    ...
    public int hashCode() {
        return Objects.hash(
                this.stepsCount, this.floorsCount, this.elevation, this.speed, this.avgCadence, this.distanceMeters);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "steps_count", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "floors_count", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "avg_cadence", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "distance_meters", nulls = Nulls.SKIP)
