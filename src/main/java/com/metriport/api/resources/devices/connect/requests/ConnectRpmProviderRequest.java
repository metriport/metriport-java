 ...
 */
package com.metriport.api.resources.devices.connect.requests;
...
@JsonDeserialize(builder = ConnectRpmProviderRequest.Builder.class)
public final class ConnectRpmProviderRequest {
    ...
    private boolean equalTo(ConnectRpmProviderRequest other) {
        return token.equals(other.token)
                && deviceUserId.equals(other.deviceUserId)
