...
@JsonDeserialize(builder = SleepBiometrics.Builder.class)
public final class SleepBiometrics {
    ...
    private SleepBiometrics(
            Optional<HeartRate> heartRate,
            Optional<HeartRateVariability> hrv,
    ...
    private boolean equalTo(SleepBiometrics other) {
        return heartRate.equals(other.heartRate)
                && hrv.equals(other.hrv)
                && respiration.equals(other.respiration)
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "respiration", nulls = Nulls.SKIP)
        ...
        public SleepBiometrics build() {
            return new SleepBiometrics(heartRate, hrv, respiration, temperature);
        }
    }
}
