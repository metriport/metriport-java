...
public final class ActivityLog {
    ...
    private ActivityLog(
            ...
            Optional<ActivityDurations> durations,
            Optional<EnergyExpenditure> energyExpenditure,
            Optional<ActivityMovement> movement,
    ...
    private boolean equalTo(ActivityLog other) {
        return metadata.equals(other.metadata)
                ...
                && energyExpenditure.equals(other.energyExpenditure)
    ...
    public static final class Builder implements MetadataStage, _FinalStage {
        ...
        @Override
        @JsonSetter(value = "biometrics", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "movement", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "energy_expenditure", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "durations", nulls = Nulls.SKIP)
