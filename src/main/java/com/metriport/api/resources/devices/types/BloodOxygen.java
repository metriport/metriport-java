...
@JsonDeserialize(builder = BloodOxygen.Builder.class)
public final class BloodOxygen {
    ...
    private BloodOxygen(
            Optional<Double> minPct, Optional<Double> maxPct, Optional<Double> avgPct, Optional<Double> stdDev) {
        this.minPct = minPct;
        this.maxPct = maxPct;
        this.avgPct = avgPct;
        this.stdDev = stdDev;
    ...
    private boolean equalTo(BloodOxygen other) {
        return minPct.equals(other.minPct)
                && maxPct.equals(other.maxPct)
                && avgPct.equals(other.avgPct)
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "min_pct", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "max_pct", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "avg_pct", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "std_dev", nulls = Nulls.SKIP)
