...
public final class HeartRate {
    ...
    private HeartRate(
            Optional<Integer> minBpm,
            Optional<Integer> maxBpm,
            Optional<Integer> avgBpm,
            Optional<Integer> restingBpm,
            Optional<List<Sample>> samplesBpm) {
        this.minBpm = minBpm;
        this.maxBpm = maxBpm;
        this.avgBpm = avgBpm;
    ...
    private boolean equalTo(HeartRate other) {
        return minBpm.equals(other.minBpm)
                && maxBpm.equals(other.maxBpm)
                && avgBpm.equals(other.avgBpm)
                && restingBpm.equals(other.restingBpm)
                && samplesBpm.equals(other.samplesBpm);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "samples_bpm", nulls = Nulls.SKIP)
