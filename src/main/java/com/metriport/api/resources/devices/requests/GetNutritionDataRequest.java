...
@JsonDeserialize(builder = GetNutritionDataRequest.Builder.class)
public final class GetNutritionDataRequest {
    ...
    private GetNutritionDataRequest(String userId, String date, String timezoneId) {
        this.userId = userId;
        this.date = date;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetNutritionDataRequest && equalTo((GetNutritionDataRequest) other);
    }

    private boolean equalTo(GetNutritionDataRequest other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(GetNutritionDataRequest other);
    }
    ...
    public static final class Builder implements UserIdStage, DateStage, TimezoneIdStage, _FinalStage {
        ...
        @Override
        public Builder from(GetNutritionDataRequest other) {
        ...
        @Override
        public GetNutritionDataRequest build() {
            return new GetNutritionDataRequest(userId, date, timezoneId);
        }
    }
}
