...
@JsonDeserialize(builder = GetSleepDataRequest.Builder.class)
public final class GetSleepDataRequest {
    ...
    private GetSleepDataRequest(String userId, String date, String timezoneId) {
        this.userId = userId;
        this.date = date;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetSleepDataRequest && equalTo((GetSleepDataRequest) other);
    }

    private boolean equalTo(GetSleepDataRequest other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(GetSleepDataRequest other);
    }
    ...
    public static final class Builder implements UserIdStage, DateStage, TimezoneIdStage, _FinalStage {
        ...
        @Override
        public Builder from(GetSleepDataRequest other) {
        ...
        @Override
        public GetSleepDataRequest build() {
            return new GetSleepDataRequest(userId, date, timezoneId);
        }
    }
}
