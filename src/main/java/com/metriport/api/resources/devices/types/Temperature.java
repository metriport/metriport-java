...
@JsonDeserialize(builder = Temperature.Builder.class)
public final class Temperature {
    ...
    private Temperature(
            Optional<TemperatureMeasurement> core,
            Optional<Double> deltaCelcius,
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "core", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "delta_celcius", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "skin", nulls = Nulls.SKIP)
