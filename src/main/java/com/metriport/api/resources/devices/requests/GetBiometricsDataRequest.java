 ...
 */
package com.metriport.api.resources.devices.requests;
...
@JsonDeserialize(builder = GetBiometricsDataRequest.Builder.class)
public final class GetBiometricsDataRequest {
    ...
    private GetBiometricsDataRequest(String userId, String date, String timezoneId) {
        this.userId = userId;
        this.date = date;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetBiometricsDataRequest && equalTo((GetBiometricsDataRequest) other);
    }

    private boolean equalTo(GetBiometricsDataRequest other) {
    ...
    public interface UserIdStage {
        ...
        Builder from(GetBiometricsDataRequest other);
    }
    ...
    public interface _FinalStage {
        GetBiometricsDataRequest build();
    }
    ...
    public static final class Builder implements UserIdStage, DateStage, TimezoneIdStage, _FinalStage {
        ...
        @Override
        public Builder from(GetBiometricsDataRequest other) {
        ...
        @Override
        public GetBiometricsDataRequest build() {
            return new GetBiometricsDataRequest(userId, date, timezoneId);
        }
    }
}
