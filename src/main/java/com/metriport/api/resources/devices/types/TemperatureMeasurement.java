...
@JsonDeserialize(builder = TemperatureMeasurement.Builder.class)
public final class TemperatureMeasurement {
    ...
    private TemperatureMeasurement(Optional<Double> avgCelcius, Optional<List<Sample>> samplesCelcius) {
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "avg_celcius", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "samples_celcius", nulls = Nulls.SKIP)
