 ...
 */
package com.metriport.api.resources.devices.connect;
...
import com.metriport.api.resources.devices.connect.requests.ConnectRpmProviderRequest;
...
public class ConnectClient {
     ...
     */
    public void connectRpmProvider(String provider, ConnectRpmProviderRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("connect")
                .addPathSegments("rpm")
                .addPathSegment(provider);
        httpUrl.addQueryParameter("token", request.getToken());
