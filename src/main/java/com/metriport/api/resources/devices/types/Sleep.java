...
public final class Sleep implements IMetriportData {
    ...
    private Sleep(
            ...
            Optional<SleepDurations> durations,
            Optional<SleepBiometrics> biometrics,
    ...
    private boolean equalTo(Sleep other) {
        return metadata.equals(other.metadata)
                ...
                && wakeupFrequency.equals(other.wakeupFrequency);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                this.metadata, this.startTime, this.endTime, this.durations, this.biometrics, this.wakeupFrequency);
    }
    ...
    public static final class Builder implements MetadataStage, _FinalStage {
        ...
        @Override
        @JsonSetter(value = "wakeup_frequency", nulls = Nulls.SKIP)
