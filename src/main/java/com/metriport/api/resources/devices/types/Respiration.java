...
@JsonDeserialize(builder = Respiration.Builder.class)
public final class Respiration {
    ...
    private Respiration(
            Optional<Integer> vo2Max,
            Optional<BloodOxygen> spo2,
            Optional<Integer> avgBreathsPerMinute,
            Optional<Integer> peakFlowLMin,
            Optional<Integer> forcedVolumeL,
            Optional<List<Sample>> samplesBreathsPerMinute) {
        this.vo2Max = vo2Max;
        this.spo2 = spo2;
    ...
    private boolean equalTo(Respiration other) {
        return vo2Max.equals(other.vo2Max)
                && spo2.equals(other.spo2)
                && avgBreathsPerMinute.equals(other.avgBreathsPerMinute)
                && peakFlowLMin.equals(other.peakFlowLMin)
                && forcedVolumeL.equals(other.forcedVolumeL)
                && samplesBreathsPerMinute.equals(other.samplesBreathsPerMinute);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                this.vo2Max,
                this.spo2,
                this.avgBreathsPerMinute,
                this.peakFlowLMin,
                this.forcedVolumeL,
                this.samplesBreathsPerMinute);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "vo2_max", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "spo2", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "avg_breaths_per_minute", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "peak_flow_L_min", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "forced_volume_L", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "samples_breaths_per_minute", nulls = Nulls.SKIP)
        ...
        public Respiration build() {
            return new Respiration(
                    vo2Max, spo2, avgBreathsPerMinute, peakFlowLMin, forcedVolumeL, samplesBreathsPerMinute);
        }
    }
}
