...
public final class Macros {
    ...
    private Macros(
            Optional<Integer> alcoholG,
            Optional<Integer> carbsG,
            Optional<Integer> cholesterolMg,
            Optional<Integer> energyKcal,
            Optional<Integer> fatG,
            Optional<Integer> fiberG,
            Optional<Integer> proteinG,
            Optional<Integer> sodiumMg,
            Optional<Integer> sugarG,
            Optional<Integer> transFatG,
            Optional<Integer> waterMl) {
    ...
    private boolean equalTo(Macros other) {
        return alcoholG.equals(other.alcoholG)
                && carbsG.equals(other.carbsG)
                && cholesterolMg.equals(other.cholesterolMg)
                && energyKcal.equals(other.energyKcal)
                && fatG.equals(other.fatG)
                && fiberG.equals(other.fiberG)
                && proteinG.equals(other.proteinG)
                && sodiumMg.equals(other.sodiumMg)
                && sugarG.equals(other.sugarG)
                && transFatG.equals(other.transFatG)
                && waterMl.equals(other.waterMl);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "alcohol_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "carbs_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "cholesterol_mg", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "energy_kcal", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "fat_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "fiber_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "protein_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "sodium_mg", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "sugar_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "trans_fat_g", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "water_ml", nulls = Nulls.SKIP)
