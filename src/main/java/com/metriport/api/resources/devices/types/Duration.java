...
public final class Duration {
    ...
    private Duration(
            Optional<Integer> restSeconds,
            Optional<Integer> veryLowSeconds,
            Optional<Integer> lowSeconds,
            Optional<Integer> medSeconds,
            Optional<Integer> highSeconds) {
    ...
    private boolean equalTo(Duration other) {
        return restSeconds.equals(other.restSeconds)
                && veryLowSeconds.equals(other.veryLowSeconds)
                && lowSeconds.equals(other.lowSeconds)
                && medSeconds.equals(other.medSeconds)
                && highSeconds.equals(other.highSeconds);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "rest_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "very_low_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "low_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "med_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "high_seconds", nulls = Nulls.SKIP)
