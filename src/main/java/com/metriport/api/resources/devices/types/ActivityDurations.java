...
@JsonDeserialize(builder = ActivityDurations.Builder.class)
public final class ActivityDurations {
    ...
    private ActivityDurations(
            Optional<Integer> activeSeconds, Optional<Duration> intensity, Optional<Duration> strain) {
    ...
    private boolean equalTo(ActivityDurations other) {
        return activeSeconds.equals(other.activeSeconds)
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "active_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "strain", nulls = Nulls.SKIP)
