...
@JsonDeserialize(builder = ConnectedUserInfo.Builder.class)
public final class ConnectedUserInfo {
    ...
    private ConnectedUserInfo(String metriportUserId, String appUserId, Optional<List<String>> connectedProviders) {
    ...
    private boolean equalTo(ConnectedUserInfo other) {
        return metriportUserId.equals(other.metriportUserId)
                && appUserId.equals(other.appUserId)
                && connectedProviders.equals(other.connectedProviders);
    }
    ...
    public static final class Builder implements MetriportUserIdStage, AppUserIdStage, _FinalStage {
        ...
        @Override
        @JsonSetter(value = "connectedProviders", nulls = Nulls.SKIP)
