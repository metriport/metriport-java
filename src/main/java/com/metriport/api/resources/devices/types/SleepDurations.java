...
@JsonDeserialize(builder = SleepDurations.Builder.class)
public final class SleepDurations {
    ...
    private SleepDurations(
            Optional<Integer> totalSeconds,
            Optional<Integer> awakeSeconds,
            Optional<Integer> deepSeconds,
            Optional<Integer> remSeconds,
            Optional<Integer> lightSeconds,
            Optional<Integer> inBedSeconds,
            Optional<Integer> timeToFallAsleepSeconds,
    ...
    private boolean equalTo(SleepDurations other) {
        return totalSeconds.equals(other.totalSeconds)
                && awakeSeconds.equals(other.awakeSeconds)
                && deepSeconds.equals(other.deepSeconds)
                && remSeconds.equals(other.remSeconds)
                && lightSeconds.equals(other.lightSeconds)
                && inBedSeconds.equals(other.inBedSeconds)
                && timeToFallAsleepSeconds.equals(other.timeToFallAsleepSeconds)
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "total_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "awake_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "deep_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "rem_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "light_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "in_bed_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "time_to_fall_asleep_seconds", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "no_data_seconds", nulls = Nulls.SKIP)
