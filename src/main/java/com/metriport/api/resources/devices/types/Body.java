...
public final class Body implements IMetriportData {
    ...
    private Body(
            Metadata metadata,
            Optional<Double> bodyFatPct,
            Optional<Double> heightCm,
            Optional<Double> weightKg,
            Optional<Double> boneMassKg,
            Optional<Double> muscleMassKg,
            Optional<Double> leanMassKg,
            Optional<Double> maxPossibleHeartRateBpm,
    ...
    private boolean equalTo(Body other) {
        return metadata.equals(other.metadata)
                && bodyFatPct.equals(other.bodyFatPct)
                && heightCm.equals(other.heightCm)
                && weightKg.equals(other.weightKg)
                && boneMassKg.equals(other.boneMassKg)
                && muscleMassKg.equals(other.muscleMassKg)
                && leanMassKg.equals(other.leanMassKg)
                && maxPossibleHeartRateBpm.equals(other.maxPossibleHeartRateBpm)
                && weightSamplesKg.equals(other.weightSamplesKg);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                this.muscleMassKg,
                this.leanMassKg,
                this.maxPossibleHeartRateBpm,
                this.weightSamplesKg);
    }
    ...
    public static final class Builder implements MetadataStage, _FinalStage {
        ...
        @Override
        @JsonSetter(value = "weight_samples_kg", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "max_possible_heart_rate_bpm", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "lean_mass_kg", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "muscle_mass_kg", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "bone_mass_kg", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "weight_kg", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "height_cm", nulls = Nulls.SKIP)
        ...
        @Override
        @JsonSetter(value = "body_fat_pct", nulls = Nulls.SKIP)
