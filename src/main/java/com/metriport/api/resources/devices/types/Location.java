...
public final class Location {
    ...
    private Location(
            Optional<LatLon> startLatLonDeg,
            Optional<LatLon> endLatLonDeg,
            Optional<String> polystring,
    ...
    private boolean equalTo(Location other) {
        return startLatLonDeg.equals(other.startLatLonDeg)
                && endLatLonDeg.equals(other.endLatLonDeg)
                && polystring.equals(other.polystring)
    ...
    public int hashCode() {
        return Objects.hash(
                this.startLatLonDeg, this.endLatLonDeg, this.polystring, this.city, this.country, this.region);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "start_lat_lon_deg", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "end_lat_lon_deg", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "polystring", nulls = Nulls.SKIP)
