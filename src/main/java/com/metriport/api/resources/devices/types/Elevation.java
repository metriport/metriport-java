...
@JsonDeserialize(builder = Elevation.Builder.class)
public final class Elevation {
    ...
    private Elevation(Optional<Integer> gainMeters, Optional<Integer> minMeters, Optional<Integer> maxMeters) {
    ...
    private boolean equalTo(Elevation other) {
        return gainMeters.equals(other.gainMeters)
                && minMeters.equals(other.minMeters)
                && maxMeters.equals(other.maxMeters);
    }
    ...
    public static final class Builder {
        ...
        @JsonSetter(value = "gain_meters", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "min_meters", nulls = Nulls.SKIP)
        ...
        @JsonSetter(value = "max_meters", nulls = Nulls.SKIP)
