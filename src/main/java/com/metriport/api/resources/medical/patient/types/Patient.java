...
public final class Patient implements IBasePatient {
    ...
    private boolean equalTo(Patient other) {
        return firstName.equals(other.firstName)
                ...
                && genderAtBirth.equals(other.genderAtBirth)
                && personalIdentifiers.equals(other.personalIdentifiers)
    ...
    public interface GenderAtBirthStage {
        IdStage genderAtBirth(String genderAtBirth);
    }
    ...
    public static final class Builder
            implements FirstNameStage, LastNameStage, DobStage, GenderAtBirthStage, IdStage, _FinalStage {
        ...
        public IdStage genderAtBirth(String genderAtBirth) {
            this.genderAtBirth = genderAtBirth;
            return this;
        }
        ...
        @Override
        @JsonSetter(value = "personalIdentifiers", nulls = Nulls.SKIP)
